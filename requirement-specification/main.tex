...
BGP should at least implement the main API defined in \cref{sec:proddesc}.
...
\begin{usecase}
	...
	\addfield{Primary actor:}{Operator}
	\addfield{Preconditions:}{User is registered.}
	\addfield{Post-conditions:}{The user, and related data, has been removed from the system.}
	\addscenario{Main success scenario:}{
